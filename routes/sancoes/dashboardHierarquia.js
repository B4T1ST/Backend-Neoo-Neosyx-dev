...
router.get('/', function(req, res) {
  ...
  retornaDashHierarquia(loginUsuario, parametro, res)
});

async function retornaDashHierarquia(loginUsuario, parametro, res){
  try {
    let pool = await get('BDDosimetria', connection)
      ...
      let result = await pool.request()
        ...
        //executa a procedure  
        .execute('s_Sancoes_Dashboard_Retorna_Status_Hierarquia')
